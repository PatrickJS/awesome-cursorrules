...
- [Skillfold (Multi-Agent Pipeline)](./rules/skillfold-multi-agent-pipeline-cursorrules-prompt-file/.cursorrules) - Cursor rules for multi-agent AI pipeline development, generated by [Skillfold](https://github.com/byronxlg/skillfold). Combines planning, code-writing, code-review, and testing skills into a composable dev-team pipeline.
