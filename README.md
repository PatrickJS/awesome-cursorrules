...
- [Skillfold (Multi-Agent AI Pipelines)](./rules/skillfold-multi-agent-pipeline-cursorrules-prompt-file/.cursorrules) - Cursor rules for multi-agent AI pipeline configuration with YAML-based skill composition.
