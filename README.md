...
- [Network Troubleshooting (17+ AI Agents)](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/network-troubleshoot.mdc) - Universal network diagnostics for AI coding agents. Systematically diagnoses and fixes ECONNREFUSED, DNS, proxy, SSL, npm/pip/docker errors. Built from 112+ real agent sessions. Works with Cursor and 16+ other agents.
