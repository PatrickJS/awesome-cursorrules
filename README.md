...
- [Taskade MCP Server](https://github.com/taskade/mcp) - Official Taskade MCP server for Cursor. Connect AI to Taskade workspaces for project management, notes, mind maps, AI agents, and workflow automation.
