...
- [Great CTO (AI engineering management for 25 archetypes + compliance)](./rules/great-cto-cursorrules-prompt-file/.cursorrules) - Auto-generated by `npx great-cto adapt --platform cursor`. Detects 1 of 25 archetypes (fintech / healthcare / edtech / etc.) and wires up matching compliance gates. Pairs with `great-cto mcp` (5 tools: scan / list_rules / detect_archetype / estimate_cost / query_decisions) callable from Cursor chat. See also `./rules/great-cto-cursorrules-prompt-file/README.md`.
