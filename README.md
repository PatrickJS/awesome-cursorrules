...
- [gluestack-ui v4 (React Native, Expo, Next.js, NativeWind)](https://github.com/PatrickJS/awesome-cursorrules/blob/main/rules/gluestack-ui-cursorrules-prompt-file.mdc) - Semantic tokens, compound components (InputSlot/ButtonText), resolution hierarchy, tva variants, and cross-platform constraints. Adapted from the official gluestack/agent-skills repo.
